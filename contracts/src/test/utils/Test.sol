...
contract Test is DSTest {
    ...
    function setUp() virtual public {
        ...
        usdcPool = new Pool(address(usdc), address(poolRateModel), address(usdcOracle), 100e6, 90e16, 95e16, 1000000e6);
        wethPool = new Pool(address(weth), address(poolRateModel), address(wethOracle), 1e17, 80e16, 90e16, 1000e18);
        investor = new Investor();
        investorActor = new InvestorActor(address(investor));
